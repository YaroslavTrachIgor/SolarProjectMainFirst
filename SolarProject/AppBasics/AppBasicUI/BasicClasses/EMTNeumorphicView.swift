...
//  SolarProject
//
//  Created by Yaroslav Trach on 17.06.2020.
...
public class EMTNeumorphicLayer: CALayer {
    ...
    public var selected: Bool {
        ...
        set {
            ...
            elementSelectedColor = (UIColor(cgColor: color).getTransformedColor(saturation: 1, brightness: 0.9) as AnyObject).cgColor
